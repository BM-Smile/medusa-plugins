...
export declare const NAVER_STORE_STRATEGY_NAME = "naver.store.medusa-auth-plugin";
export declare const NAVER_ADMIN_STRATEGY_NAME = "naver.admin.medusa-auth-plugin";
...
export declare type NaverAuthOptions = {
    clientID: string;
    clientSecret: string;
    admin?: {
        callbackUrl: string;
